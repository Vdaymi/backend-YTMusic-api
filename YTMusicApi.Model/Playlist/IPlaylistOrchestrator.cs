...
namespace YTMusicApi.Model.Playlist
{
    public interface IPlaylistOrchestrator
    {
        ...
        Task<OptimizedPlaylistResultDto> GetOptimizedTracksAsync(string playlistId, TimeSpan timeLimit, int? maxTracks, OptimizationAlgorithmType algorithm, double genreWeight, string? startTrackId);
