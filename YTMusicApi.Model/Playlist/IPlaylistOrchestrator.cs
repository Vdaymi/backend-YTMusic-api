...
namespace YTMusicApi.Model.Playlist
{
    public interface IPlaylistOrchestrator
    {
        ...
        Task<Guid> InitiateOptimizationAsync(string playlistId, Guid userId, TimeSpan timeLimit, int? maxTracks, OptimizationAlgorithmType algorithm, double genreWeight, string? startTrackId);        
